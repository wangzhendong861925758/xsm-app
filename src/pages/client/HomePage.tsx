...
export default function HomePage() {
  ...
  return (
    <div className="min-h-full relative">
      ...
      {/* 白→蓝 渐变过渡带 */}
      <div className="h-12 bg-gradient-to-b from-white to-navy-100" />

      {/* 下半部分：蓝色背景 */}
      <div className="bg-navy-100">
        {/* 板块三下半：学习概况三栏 */}
        <section className="px-5">
          <div className="grid grid-cols-3 gap-2 ink-card rounded-2xl p-3">
        ...
        {/* 板块四：学科入口 */}
        <section className="px-5 py-6 pb-[calc(24px+env(safe-area-inset-bottom))]">
