...
export const TEXTBOOKS: TextbookConfig[] = [
  ...
  { grade: "八年级下册", subject: "geography", subjectName: "地理", versions: ["中图版", "中图版（2012）", "中图版（北京版）", "中图版（北京版）（2012）", "人教版", "人教版（2012）", "仁爱科普版 全一册", "仁爱科普版（2012）", "商务星球版", "商务星球版（2012）", "晋教版", "晋教版（2012）", "湘教版", "湘教版（2012）", "粤人版", "粤人版（2012）"] },
  ...
  // ===== 九年级下册 =====
  { grade: "九年级下册", subject: "physics", subjectName: "物理", versions: ["人教版 全一册", "人教版（2012）全一册", "北师大版 全一册", "北师大版（2012）全一册", "北师大版（北京）全一册", "北师大版（北京）（2013）全一册", "教科版 全一册", "教科版", "沪教版（上海）（2007）", "沪科版 全一册", "沪科版（2012）全一册", "沪科版（五四学制）", "沪粤版", "沪粤版（2012）", "科教版（2012）", "苏科版", "苏科版（2012）", "鲁科版（五四学制）", "鲁科版（五四学制）（2012）"] },
