...
export const TEXTBOOKS: TextbookConfig[] = [
  ...
  { grade: "九年级上册", subject: "history", subjectName: "历史", versions: ["统编版", "统编版（2016）", "人教版"] },
  { grade: "九年级上册", subject: "politics", subjectName: "道法", versions: ["统编版", "统编版（2016）", "统编版（五四学制）（2018）", "人教版"] },
