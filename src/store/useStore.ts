...
export const useStore = create<AppState>()(
  persist(
    (set) => ({
      ...
      adminLoggedIn: false,
      todayLearned: { biology: 12, politics: 8, history: 9, geography: 7, science: 0 },
      todayStats: { biology: { correct: 10, total: 12 }, politics: { correct: 6, total: 8 }, history: { correct: 7, total: 9 }, geography: { correct: 5, total: 7 }, science: { correct: 0, total: 0 } },
      answeredHistory: [],
